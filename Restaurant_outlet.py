...
def system():
    ...
    # Topframe
    topframe = Frame(root,bd=20, bg="white", width=1600, height=50)
    ...
    # Top part
    main_lbl = Label(topframe, font=('Calibri', 25, 'bold'), text="Restaurant Outlet", fg="Blue",
                   anchor=W)
    ...
    resetbtn = Button(leftframe, font=('Calibri', 16, 'bold'), text="Clear", bg="lightgrey", fg="black", bd=3, padx=5,
    ...
    def menu():
        ...
        lblpricep = Label(roott, font=("Calibri", 20, "bold"), text="300/-", fg="blue", bd=10)
        ...
        lblpricei = Label(roott, font=("Calibri", 20, "bold"), text="100/-", fg="blue", bd=10)
        ...
        lblpriced = Label(roott, font=("Calibri", 20, "bold"), text="80/-", fg="blue", bd=10)
